...
export default function Home() { 
  ...
  const [homeRef, homeVisible]: (boolean | React.MutableRefObject<undefined>)[] = useOnScreen();
  const [aboutRef, aboutVisible]: (boolean | React.MutableRefObject<undefined>)[] = useOnScreen();
  const [contactRef, contactVisible]: (boolean | React.MutableRefObject<undefined>)[] = useOnScreen();
  const [expRef, expVisible]: (boolean | React.MutableRefObject<undefined>)[] = useOnScreen();
  const [projectRef, projectVisible]: (boolean | React.MutableRefObject<undefined>)[] = useOnScreen();
