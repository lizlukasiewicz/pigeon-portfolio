      ...
      <Flex
        ...
        ref={el => pageRefs.current = { ...pageRefs.current, home: el }}>
              ...
              <Box w={'100%'} 
                  ...
                  bgGradient={uCMV("radial(circle 375px at center, #FFFFF1 46%, rgba(255,255,129, 0.52) 60%, #FFFF81 61.4%, rgba(243,186,64, 0.8) 62%, rgba(7, 18, 43, 0)82%,rgba(7, 18, 43, 0) 92%)", 
