  ...
  <div className={styles.lampMode}>
    ...
    <label className={styles.lib}> 
      ...
      <svg className={styles['svg']} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* styles['path'] */}
          <path d="M8 20H12M16 20H12M12 20V11" stroke="#020405" strokeWidth="1" strokeLinecap="round"/> 
                                                                                      {/* id={styles.onoff} */}
          <path d="M17 11V16" stroke="#020405" strokeWidth="1" strokeLinecap="round" className={styles['onoff']} /> 
          {/* styles['path'] */}
          <path d="M15 4H9C6.23858 4 4 6.23858 4 9V9.5C4 10.3284 4.67157 11 5.5 11H18.5C19.3284 11 20 10.3284 20 9.5V9C20 6.23858 17.7614 4 15 4Z" stroke="#020405" strokeWidth="1"/>
                                                                                    {/* id={styles.shine} */}
